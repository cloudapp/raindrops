...
typedef enum {
	PhotoshopE070ASCII = 'e073',
	PhotoshopE070Binary = 'e071',
	PhotoshopE070JPEG = 'e006'
} PhotoshopE070;
...
- (void) print:(id)x postscriptEncoding:(PhotoshopE070)postscriptEncoding sourceSpace:(PhotoshopE945)sourceSpace printSpace:(NSString *)printSpace intent:(PhotoshopE130)intent blackpointCompensation:(BOOL)blackpointCompensation;  // print the specified object(s)
...
@property PhotoshopLB00 source;  // source for the depth map ( default: none ) ( default: none )
...
@property PhotoshopLB03 irisShape;  // shape of the iris ( default: hexagon ) ( default: hexagon )
...
@property PhotoshopE745 distribution;  // distribution value for the noise ( default: uniform ) ( default: uniform )
